...
Route::prefix('employees')->group( function(){
	Route::view('add-employees', 'add-employees')->name('add-employees');
	Route::view('all-employees', 'all-employees')->name('all-employees');
	Route::view('generate-qr', 'generate-qr')->name('generate-qr');
});
Route::prefix('payroll')->group( function(){
	Route::view('employee-salary', 'employee-salary')->name('employee-salary');
	Route::view('payslip', 'payslip')->name('payslip');
	Route::view('manage-taxes', 'manage-taxes')->name('manage-taxes');
});
...
Route::prefix('maintenance')->group( function(){
	...
	Route::view('archive-employee', 'archive-employee')->name('archive-employee');
	Route::view('backup', 'backup')->name('backup');
});
Route::prefix('user')->group( function(){
	Route::view('time-record', 'time-record')->name('time-record');
	Route::view('generate-dtr', 'generate-dtr')->name('generate-dtr');
	Route::view('user-payslip', 'user-payslip')->name('user-payslip');
});
