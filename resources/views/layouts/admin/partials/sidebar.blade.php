        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav {{routeActive('main')}}" href="{{ route('main') }}"><i data-feather="home"></i><span>Dashboard</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/employees') }}" href="javascript:void(0)"><i data-feather="users"></i><span>Employee</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/employees') }};">
                            <li><a href="{{ route('add-employees') }}" class="{{routeActive('add-employees')}}">Add Employee</a></li>
                            <li><a href="{{ route('all-employees') }}" class="{{routeActive('all-employees')}}">All Employees</a></li>
                            <li><a href="{{ route('generate-qr') }}" class="{{routeActive('generate-qr')}}">Generate QR</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/payroll') }}" href="javascript:void(0)"><i data-feather="dollar-sign"></i><span>Payroll</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/payroll') }};">
                            <li><a href="{{ route('employee-salary') }}" class="{{routeActive('employee-salary')}}">Employee Salary</a></li>
                            <li><a href="{{ route('payslip') }}" class="{{routeActive('payslip')}}">Payslip</a></li>
                            <li><a href="{{ route('manage-taxes') }}" class="{{routeActive('manage-taxes')}}">Manage Taxes</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/reports') }}" href="javascript:void(0)"><i data-feather="file-text"></i><span>Reports</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/reports') }};">
                            <!-- <li><a href="" class="{{routeActive('job-cards-view')}}">Daily Time Record</a></li>
                            <li><a href="" class="{{routeActive('job-list-view')}}">Monthly Report</a></li>
                            <li><a href="" class="{{routeActive('job-list-view')}}">Annual Report</a></li> -->
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/maintenance') }}" href="javascript:void(0)"><i data-feather="database"></i><span>Maintenance</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/maintenance') }};">
                            <li><a href="{{ route('change-password') }}" class="{{routeActive('change-password')}}">Change Password</a></li>
                            <li><a href="{{ route('archive-employee') }}" class="{{routeActive('archive-employee')}}">Archive Employee</a></li>
                            <li><a href="{{ route('backup') }}" class="{{routeActive('backup')}}">Backup</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/user') }}" href="javascript:void(0)"><i data-feather="user-check"></i><span>User</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/user') }};">
                            <li><a href="{{ route('time-record') }}" class="{{routeActive('time-record')}}">Time Record</a></li>
                            <li><a href="{{ route('generate-dtr') }}" class="{{routeActive('generate-dtr')}}">Generate DTR</a></li>
                            <li><a href="{{ route('user-payslip') }}" class="{{routeActive('user-payslip')}}">Payslip</a></li>
                        </ul>
                    </li>
                    <!-- <li class="dropdown">
