...
(function() {
    ...
    window.db = db;
    db.countries = [
        { Name: "Information System", Id: 0 },
        { Name: "Information Technology", Id: 1 },
        { Name: "Computer Science", Id: 2 },
        { Name: "Industrial Science", Id: 3 },
        { Name: "Multimedia and Arts", Id: 4 },
        { Name: "Game Development", Id: 5 },
        { Name: "Data Analytics", Id: 6 },
        { Name: "Business Analytics", Id: 7 }
    ];
    db.clients = [
        {
            "Name": "Otto Clay",
