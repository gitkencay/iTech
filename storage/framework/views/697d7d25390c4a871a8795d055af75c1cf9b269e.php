<header class="main-nav">
    <div class="sidebar-user text-center">
        ...
        <a href="user-profile"> <h6 class="mt-3 f-14 f-w-600">John Doe</h6></a>
        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav <?php echo e(routeActive('main')); ?>" href="<?php echo e(route('main')); ?>"><i data-feather="home"></i><span>Dashboard</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/employees')); ?>" href="javascript:void(0)"><i data-feather="users"></i><span>Employee</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/employees')); ?>;">
                            <li><a href="<?php echo e(route('add-employees')); ?>" class="<?php echo e(routeActive('add-employees')); ?>">Add Employee</a></li>
                            <li><a href="<?php echo e(route('all-employees')); ?>" class="<?php echo e(routeActive('all-employees')); ?>">All Employees</a></li>
                            <li><a href="<?php echo e(route('generate-qr')); ?>" class="<?php echo e(routeActive('generate-qr')); ?>">Generate QR</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/payroll')); ?>" href="javascript:void(0)"><i data-feather="dollar-sign"></i><span>Payroll</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/payroll')); ?>;">
                            <li><a href="<?php echo e(route('employee-salary')); ?>" class="<?php echo e(routeActive('employee-salary')); ?>">Employee Salary</a></li>
                            <li><a href="<?php echo e(route('payslip')); ?>" class="<?php echo e(routeActive('payslip')); ?>">Payslip</a></li>
                            <li><a href="<?php echo e(route('manage-taxes')); ?>" class="<?php echo e(routeActive('manage-taxes')); ?>">Manage Taxes</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/reports')); ?>" href="javascript:void(0)"><i data-feather="file-text"></i><span>Reports</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/reports')); ?>;">
                            <!-- <li><a href="" class="<?php echo e(routeActive('job-cards-view')); ?>">Daily Time Record</a></li>
                            <li><a href="" class="<?php echo e(routeActive('job-list-view')); ?>">Monthly Report</a></li>
                            <li><a href="" class="<?php echo e(routeActive('job-list-view')); ?>">Annual Report</a></li> -->
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/maintenance')); ?>" href="javascript:void(0)"><i data-feather="database"></i><span>Maintenance</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/maintenance')); ?>;">
                            <li><a href="<?php echo e(route('change-password')); ?>" class="<?php echo e(routeActive('change-password')); ?>">Change Password</a></li>
                            <li><a href="<?php echo e(route('archive-employee')); ?>" class="<?php echo e(routeActive('archive-employee')); ?>">Archive Employee</a></li>
                            <li><a href="<?php echo e(route('backup')); ?>" class="<?php echo e(routeActive('backup')); ?>">Backup</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/user')); ?>" href="javascript:void(0)"><i data-feather="user-check"></i><span>User</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/user')); ?>;">
                            <li><a href="<?php echo e(route('time-record')); ?>" class="<?php echo e(routeActive('time-record')); ?>">Time Record</a></li>
                            <li><a href="<?php echo e(route('generate-dtr')); ?>" class="<?php echo e(routeActive('generate-dtr')); ?>">Generate DTR</a></li>
                            <li><a href="<?php echo e(route('user-payslip')); ?>" class="<?php echo e(routeActive('user-payslip')); ?>">Payslip</a></li>
                        </ul>
                    </li>
                    <!-- <li class="dropdown">
...
<?php /**PATH C:\Users\Ken\Downloads\Compressed\vihoadmin-10\viho_html_laravel\Viho-Laravel-8\theme\resources\views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>